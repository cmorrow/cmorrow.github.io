	...
	<div class="formBox">
              ...
              <tr>
                <td>
                  <asp:TextBox runat="server" ID="tbParentFirstName" MaxLength="128" /><asp:RequiredFieldValidator
                    runat="server" ID="rfvParentFirstName" ControlToValidate="tbParentFirstName" Display="Dynamic"
                    ErrorMessage="" />
                </td>
                <td>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <asp:RegularExpressionValidator ID="revParentEmail" runat="server" ErrorMessage=""
                    ControlToValidate="tbParentEmail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                    Display="Dynamic" />
                </td>
              </tr>
            </table>
      ...
      <asp:Panel runat="server" ID="pnlTabsSchool">
            <table class="table-form" width="504px">
              ...
              <tr>
                <td>
                  <span>*</span>Is your school a TABS member?
                  <asp:RadioButtonList runat="server" ID="rblTabsMember" OnSelectedIndexChanged="rblTabsMember_SelectedIndexChanged"
                    AutoPostBack="true" RepeatDirection="Horizontal">
                    <asp:ListItem Text="Yes" />
                    <asp:ListItem Text="No" />
                  </asp:RadioButtonList>
                  <asp:RequiredFieldValidator ID="rfvTabsMember" runat="server" ErrorMessage="" ControlToValidate="rblTabsMember"
              ...
              <tr>
                <asp:Panel runat="server" ID="pnlTabsYes" Visible="false">
                  <td>
                    School/Organization:
                    <asp:DropDownList runat="server" ID="ddlTabsSchools" DataTextField="schoolname" DataValueField="schoolid" />
                  </td>
                </asp:Panel>
                <asp:Panel runat="server" ID="pnlTabsNo" Visible="false">
                  <td>
                    School/Library/Non-Profit:
                    <asp:TextBox runat="server" ID="tbSchool" />
                  </td>
                </asp:Panel>
              </tr>
            </table>
          ...
          <table class="table-form" width="504px">
            ...
            <tr>
              <td>
                <asp:TextBox runat="server" ID="tbFirstName" MaxLength="128" /><asp:RequiredFieldValidator
                  runat="server" ID="rfvFirstName" ControlToValidate="tbFirstName" Display="Dynamic"
                  ErrorMessage="" />
              </td>
              <td>
                <asp:TextBox runat="server" ID="tbLastName" MaxLength="128" /><asp:RequiredFieldValidator
                  runat="server" ID="rfvLastName" ControlToValidate="tbLastName" Display="Dynamic"
                  ErrorMessage="" />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2">
                <asp:TextBox runat="server" ID="tbEmail" MaxLength="254" /><asp:RequiredFieldValidator
                  runat="server" ID="rfvEmail" ControlToValidate="tbEmail" Display="Dynamic" ErrorMessage="" />
                <asp:RegularExpressionValidator ID="revEmail" runat="server" ErrorMessage="Please enter a valid Email address."
            ...
            <tr>
              ...
              <td>
                <asp:DropDownList ID="ddlCountry" runat="server" AppendDataBoundItems="true" AutoPostBack="true"
                  DataTextField="country" DataValueField="countryid" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged" />
            ...
            <tr>
              <td>
                ...
                <asp:RequiredFieldValidator ID="rfvZip" runat="server" ErrorMessage="" Display="Dynamic"
                  ControlToValidate="tbZip" />
              </td>
              <td>
                <asp:DropDownList ID="ddlState" runat="server" AppendDataBoundItems="false" Enabled="false"
          ...
          <asp:Panel runat="server" ID="pnlMoreStudentInfo" Visible="false">
            <table class="table-form" width="504px">
              <asp:Panel runat="server" ID="pnlAboutTheStudent" Visible="false">
                ...
                <tr>
                  <td colspan="2">
                    <span>*</span>Relationship to the student:
                  </td>
                </tr>
                <tr>
                  <td colspan="2">
                    <asp:DropDownList runat="server" ID="ddlRelationship" DataTextField="description"
                      DataValueField="relationshiptostudentid" />
                    <asp:RequiredFieldValidator ID="rfvRelationship" runat="server" ErrorMessage=""
                      ControlToValidate="ddlRelationship" Display="Dynamic" InitialValue="0" />
                  </td>
                </tr>
              </asp:Panel>
              <tr>
                <td colspan="2">
                  <span>*</span><asp:Literal runat="server" ID="litIam" />:
                </td>
              </tr>
              <tr>
                <td colspan="2">
              ...
              <tr>
                <td colspan="2">
                  <span>*</span><asp:Literal runat="server" ID="litStudentCitizenship" />:
                </td>
              </tr>
              <tr>
                <td colspan="2">
                  ...
                  <asp:RequiredFieldValidator ID="rfvCitizenship" runat="server" ErrorMessage="" ControlToValidate="ddlCitizenship"
                    Display="Dynamic" InitialValue="0" />
                </td>
              </tr>
              <tr>
                <td>
                 <span>*</span> <asp:Literal runat="server" ID="litCurrentGrade" />:
                </td>
                <td>
              ...
              <tr>
                <td>
                  <asp:DropDownList runat="server" ID="ddlCurrentSchoolType" DataTextField="description"
                    DataValueField="schooltypeid" />
                </td>
                <td>
                  <asp:DropDownList runat="server" ID="ddlInterestLevel" DataTextField="description"
                    DataValueField="interestlevelid" />
                </td>
              </tr>
              <asp:Panel runat="server" ID="pnlParentInterestLevel" Visible="false">
                ...
                <tr>
                  ...
                  <td>
                    <asp:DropDownList runat="server" ID="ddlParentInterestLevel" DataTextField="description"
                      DataValueField="interestlevelid" />
                  </td>
                </tr>
              </asp:Panel>
          ...
          <table class="table-form" width="504px">
            ...
            <tr>
              <td>
                 <span>*</span>Number of Catalogs Requested:
              </td>
              <td>
                Total Cost:
              </td>
            ...
            <tr>
              <td>
                <asp:TextBox runat="server" ID="tbNumberofCatalogs" OnTextChanged="tbNumberofCatalogs_TextChanged"
                  AutoPostBack="true" /><asp:RequiredFieldValidator runat="server" ID="rfvNumberOfCatalogs"
                    ControlToValidate="tbNumberofCatalogs" Display="Dynamic" ErrorMessage="" />
                <asp:CompareValidator ID="cvNumberOfCatalogs" runat="server" ErrorMessage="Please enter a valid number for the number of catalogs being requested."
                  ControlToValidate="tbNumberofCatalogs" Operator="DataTypeCheck" Type="Integer"
                  Display="Dynamic" />
              </td>
              <td>
      ...
      <asp:Panel runat="server" ID="pnlCreditCard" Visible="false">
        <table class="table-form" width="504px">
          ...
          <tr>
            <td colspan="2">
              <asp:RadioButton runat="server" ID="rbVisa" Text="Visa" GroupName="grpCreditCard"
                Checked="true" />
              <asp:RadioButton runat="server" ID="rbMasterCard" Text="Master Card" GroupName="grpCreditCard" />
              <asp:RadioButton runat="server" ID="rbAmericanExpress" Text="American Express" GroupName="grpCreditCard" />
            </td>
          </tr>
          <tr>
            <td>
               <span>*</span>First Name on Card:
            </td>
            <td>
               <span>*</span>Last Name on Card:
            </td>
          </tr>
          <tr>
            <td>
              <asp:TextBox runat="server" ID="tbFirstNameOnCard" MaxLength="128" />
              <asp:RequiredFieldValidator ID="rfvFirstNameOnCard" runat="server" ErrorMessage=""
                Display="Dynamic" ControlToValidate="tbFirstNameOnCard" />
            </td>
            <td>
              <asp:TextBox runat="server" ID="tbLastNameOnCard" MaxLength="128" />
              <asp:RequiredFieldValidator ID="rfvLastNameOnCard" runat="server" ErrorMessage=""
                Display="Dynamic" ControlToValidate="tbLastNameOnCard" />
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            <td>
              <asp:TextBox runat="server" ID="tbCreditCardNumber" MaxLength="254" /><asp:RequiredFieldValidator
                ID="rfvCreditCardNumber" runat="server" ErrorMessage="" Display="Dynamic" ControlToValidate="tbCreditCardNumber" />
            </td>
            <td>
              <asp:TextBox runat="server" ID="tbCVV" MaxLength="4" Width="35px" /><asp:RequiredFieldValidator
                ID="rfvCVV" runat="server" ErrorMessage="" Display="Dynamic" ControlToValidate="tbCVV" /><asp:CompareValidator
                  ID="cvCVV" runat="server" ErrorMessage="Please enter a valid CVV number." ControlToValidate="tbCVV"
          ...
          <tr>
            <td colspan="2">
              <table width="105px">
                <tr>
                  <td width="45px">
                    <asp:TextBox runat="server" ID="tbExpirationMonth" MaxLength="2" Width="20px" />
                    <asp:RequiredFieldValidator ID="rfvExpirationMonth" runat="server" ErrorMessage=""
                      Display="Dynamic" ControlToValidate="tbExpirationMonth" /><asp:CompareValidator ID="cvExpirationMonth"
                        runat="server" ErrorMessage="Please enter a valid expiration month." ControlToValidate="tbExpirationMonth"
                        Operator="DataTypeCheck" Type="Integer" Display="Dynamic" />
                    /
                  </td>
                  <td width="60px">
                    <asp:TextBox runat="server" ID="tbExpirationYear" MaxLength="4" Width="35px" />
                    <asp:RequiredFieldValidator ID="rfvExpirationYear" runat="server" ErrorMessage=""
                      Display="Dynamic" ControlToValidate="tbExpirationYear" /><asp:CompareValidator ID="cvExpirationYear"
                        runat="server" ErrorMessage="Please enter a valid expiration year." ControlToValidate="tbExpirationYear"
                        Operator="DataTypeCheck" Type="Integer" Display="Dynamic" />
                  </td>
                </tr>
                <tr>
        ...
        <table class="table-form" width="504px">
          ...
          <tr>
            <td>
              <asp:CheckBox runat="server" ID="cbSameAsMailingAddress" Text="Same as mailing address"
                OnCheckedChanged="cbSameAsMailingAddress_CheckedChanged" AutoPostBack="true" CausesValidation="false" />
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            ...
            <td>
              <asp:TextBox runat="server" ID="tbBillingLastName" MaxLength="128" /><asp:RequiredFieldValidator
                runat="server" ID="rfvBillingLastName" ControlToValidate="tbBillingLastName" Display="Dynamic"
                ErrorMessage="" />
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td>
              <asp:TextBox runat="server" ID="tbBillingStreetAddress1" MaxLength="254" /><asp:RequiredFieldValidator
                runat="server" ID="rfvBillingStreetAddress1" ControlToValidate="tbBillingStreetAddress1"
                Display="Dynamic" ErrorMessage="" />
            </td>
            <td>
          ...
          <tr>
            <td>
              <asp:TextBox runat="server" ID="tbBillingCity" MaxLength="128" /><asp:RequiredFieldValidator
                runat="server" ID="rfvBillingCity" ControlToValidate="tbBillingCity" Display="Dynamic"
                ErrorMessage="" />
            </td>
            <td>
              <asp:DropDownList ID="ddlBillingCountry" runat="server" AppendDataBoundItems="true"
                AutoPostBack="true" DataTextField="country" DataValueField="countryid" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged" />
          ...
          <tr>
            ...
            <td>
              <asp:DropDownList ID="ddlBillingState" runat="server" AppendDataBoundItems="true"
                Enabled="false" DataTextField="state" DataValueField="stateid" />
      ...
      <asp:Panel runat="server" ID="pnlOtherPreferences" Visible="false">
        <table class="table-form" width="504px">
          ...
          <tr>
            <td>
              <asp:CheckBox runat="server" ID="cbEmailUpdates" Text="I would like to receive email updates from TABS."
                Checked="true" /><br />
      ...
      <table class="table-form" width="504px">
        <tr>
          <td>
            <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="edit-save" OnClick="btnSubmit_Click" /><asp:Button
              runat="server" ID="btnCancel" Text="Cancel" CssClass="edit-reset" OnClick="btnCancel_Click"
