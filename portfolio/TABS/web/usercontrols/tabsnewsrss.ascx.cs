...
namespace TABS_UserControls.usercontrols {
    public partial class tabsnewsrss : System.Web.UI.UserControl {
        protected void Page_Load(object sender, EventArgs e) {
            ...
            feedWriter.WriteElementString("title", "TABS News");
            ...
            if (dt.Rows.Count > 0) {
                foreach (DataRow row in dt.Rows) {
                    ...
                    string baseurl = "/about-tabs/about-us/press-room/articles.aspx?section=tab&id=";
                    feedWriter.WriteElementString("link", baseurl + row["tabsnewsid"].ToString());
