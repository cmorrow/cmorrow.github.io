...
<ul class="sf-menu sf-navbar">
	...
	<li id="liStudents" runat="server"><a href="/for-students.aspx" class="for-students">for students</a>
		<ul>
		    <li id="liforstudents" runat="server"><a href="/for-students.aspx">student lounge</a></li>
			<li id="lithebasics" runat="server"><a href="/for-students/the-basics.aspx">the basics</a></li>
			<li id="li5goodreasons" runat="server"><a href="/for-students/5-good-reasons.aspx">5 good reasons</a></li>
			<li id="lioldschool" runat="server"><a href="/for-students/old-school.aspx" class="arrow">old school</a>
				<ul>
			...
			<li id="limyths101" runat="server"><a href="/for-students/myths-101.aspx">myths 101</a></li>
		</ul>
	</li>
	<li id="liParents" runat="server"><a href="/for-parents.aspx" class="for-parents">for parents</a>
		<ul>
		    <li id="liforparents" runat="server"><a href="/for-parents.aspx">open house</a></li>
			<li id="lithefundamentals" runat="server"><a href="/for-parents/the-fundamentals.aspx">the fundamentals</a></li>
			<li id="litheadvantages" runat="server"><a href="/for-parents/the-advantages.aspx">the advantages</a></li>
			<li id="lithetradition" runat="server"><a href="/for-parents/the-tradition.aspx" class="arrow">the tradition</a>
				<ul>
			...
			<li id="licommonmisconceptions" runat="server"><a href="/for-parents/common-misconceptions.aspx">common misconceptions</a></li>
		</ul>
	</li>
	<li id="liFindSchool" runat="server"><a href="/find-a-school.aspx" class="find-a-school">find a school</a>
		<ul>
			<li id="lifindaschool" runat="server"><a href="/find-a-school.aspx" class="arrow">search tools</a>
			    <ul>
			...
			<li runat="server" id="liexploreyouroptions"><a href="/find-a-school/explore-your-options.aspx" class="arrow">explore your options</a>
				<ul>
			...
			<li runat="server" id="lifindanexpert"><a href="/find-a-school/find-an-expert.aspx">find an expert</a></li>
			<li runat="server" id="lisummerprograms"><a href="/find-a-school/summer-programs.aspx">summer programs</a></li>
		</ul>
	</li>
	<li id="liApply" runat="server"><a href="/how-to-apply.aspx" class="how-to-apply">how to apply</a>
	    <ul>
	        ...
	        <li id="liapplication" runat="server"><a href="/how-to-apply/application.aspx">application</a></li>
	        <li id="litesting" runat="server"><a href="/how-to-apply/testing.aspx">testing</a></li>
	        <li id="liexpensesaid" runat="server"><a href="/how-to-apply/expenses--aid.aspx">expenses &amp; aid</a></li>
	        <li id="liafteryouapply" runat="server"><a href="/how-to-apply/after-you-apply.aspx">after you apply</a></li>
	        <li id="liinternationalapplicants" runat="server"><a href="/how-to-apply/international-applicants.aspx" class="arrow">international applicants</a>
	            <ul>
	...
	<li id="liSchools" runat="server"><a class="for-schools" href="/for-schools.aspx">for schools</a>
	    <ul>
	        <li runat="server" id="lioverview"><a href="/for-schools.aspx" class="arrow">overview</a>
	            <ul id="lijointabs" runat="server">
	                <li><a href="/for-schools/overview/join-tabs.aspx">join TABS</a></li>            
	            </ul>
	        </li>
	        <li id="liprofessionaldevelopment" runat="server"><a href="/for-schools/professional-development.aspx" class="arrow">professional development</a>
	            <ul>
	        ...
	        <li id="limarketing" runat="server"><a href="/for-schools/marketing.aspx" class="arrow">marketing</a>
	            <ul>
	        ...
	        <li id="litabslibrary" runat="server"><a href="/for-schools/tabs-library.aspx" class="arrow">TABS library</a>
	            <ul>
	        ...
	        <li id="lijobboard" runat="server"><a href="/for-schools/job-board.aspx">job board</a></li>
	        <li id="lisponsors" runat="server"><a href="/for-schools/sponsors.aspx">sponsors</a></li>
	        <li id="lieducationalconsultants" runat="server"><a href="/for-schools/educational-consultants.aspx">educational consultants</a></li>
	    </ul>
	</li>			    
	<li id="liTABS" runat="server"><a href="/about-tabs.aspx" class="about-tabs">about TABS</a>
	    <ul>
	        <li id="liabouttabs" runat="server"><a href="/about-tabs.aspx" class="arrow">about us</a>
	            <ul>
	        ...
	        <li id="licorporatesponsors" runat="server"><a href="/about-tabs/corporate-sponsors.aspx" class="arrow">corporate sponsors</a>
	            <ul>
	        ...
	        <li id="lifriendsineducation" runat="server"><a href="/about-tabs/friends-in-education.aspx" class="arrow">friends in education</a>
	            <ul>
	        ...
	        <li id="licontactus" runat="server"><a href="/about-tabs/contact-us.aspx" class="arrow">contact us</a>
	            <ul>
	        ...
	        <a href="/about-tabs/send-an-idea.aspx" class="arrow">send an idea</a>
	        </li>
