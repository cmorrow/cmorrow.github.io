  ...
  <ContentTemplate>
    ...
    <div class="bl left18 top15 left">
      <div class="search-results">
		<input id="searchTab" type="hidden" value="school-Tab" name="searchTab" />
        <h1>Search Results</h1>
        <div class="users-tabs">
          <ul class="conf-tabs-ul">
            <li id="schoolTab" class="school-Tab" runat="server" class="active"><a href="#school-Tab"><span>Schools</span></a></li>
            <li id="familyTab" class="family-Tab" runat="server"><a href="#family-Tab" id="family-tab"><span>Events for Families</span></a></li>
            <li id="schooleventTab" class="school-eventTab" runat="server"><a href="#school-eventTab" id="school-event-Tab"><span>Events for Schools</span></a></li>
            <li id="tabsTab" class="tabs-Tab" runat="server"><a href="#tabs-Tab" id="tabs-tab"><span>TABS Events</span></a></li>
            <div class="clear"></div>
          </ul>
          <div id="school-Tab">
