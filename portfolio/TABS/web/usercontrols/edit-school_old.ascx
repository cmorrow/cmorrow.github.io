  ...
  <div>
      ...
      <div class="edit-images">
        <div class="floatclear left textnimg">
          ...
          <div class="schoolFrontImg">
            <asp:Image ID="imgPhotoImage1" runat="server" Width="221" Height="114" Visible="false" />
          </div>
        </div>
        <div class="imgup left">
          <br />
      ...
      <div class="edit-images">
        <div class="floatclear left textnimg">
          ...
          <div class="schoolBackImg">
            <asp:Image ID="imgPhotoImage2" runat="server" Width="379" Height="160" Visible="false" />
          </div>
        </div>
        <div class="imgup left">
    ...
    <div class="edit-school-border">
      <div class="left">
        ...
        <p><em class="notice">(300 characters)</em></p>
      </div>
    ...
    <div class="edit-school-border">
      ...
      <p>
        <a href="/for-schools/edit-school-profile/add-school-event.aspx">Add Event</a></p>
    </div>
    <div class="edit-school-border">
      <h5>
      ...
      <p>
        <a href="/for-schools/edit-school-profile/add-school-news.aspx">Add News</a></p>
    </div>
    <div class="edit-school-border hos">
      ...
      <div>
        ...
        <asp:RadioButtonList ID="radioHeadmasterHiatus" runat="server" TextAlign="right" CssClass="yesNoRadio"
      ...
      <div>
        ...
        <asp:RadioButtonList ID="radioHeadmasterRetiring" runat="server" TextAlign="right" CssClass="yesNoRadio"
          RepeatDirection="Horizontal">
          <asp:ListItem Text="Yes" Value="1" />
          <asp:ListItem Text="No" Value="2" />
        </asp:RadioButtonList>
    ...
    <div class="edit-school-border">
      <h5>
        <span>*</span>specific grades offered</h5>
...
<div class="edit-school-tabs">
  ...
  <div>
    ...
    <div style="display: none;" class="edit-school-border">
      <h5>
      ...
      <table cellpadding="5" cellspacing="0" border="0" class="edit-small">
        <tr>
          ...
          <td>
            <asp:TextBox ID="textDivInternational" runat="server" Text="0" />
          </td>
          <td>
          ...
          <td>
            <asp:TextBox ID="textDivInternationalColor" runat="server" Text="0" />
          </td>
          <td>
            <span>*</span><b>No. of Domestic Students of Color:</b>
          </td>
          <td>
            <asp:TextBox ID="textDivDomestic" runat="server" Text="0" />
          </td>
          <td>
    ...
    <div class="edit-school-border">
      ...
      <cc1:Grid ID="gridStudentCountry" runat="server" AllowAddingRecords="true" AutoGenerateColumns="False"
        OnRowDataBound="gridStudentCountry_RowDataBound" OnInsertCommand="gridStudentCountry_InsertCommand">
        <Columns>
          <cc1:Column DataField="country" HeaderText="Country" AllowEdit="true" Width="500"
            EditTemplateId="tplEditCountry" runat="server">
          </cc1:Column>
          <cc1:Column DataField="studentcount" AllowEdit="true" HeaderText="No. Students" Width="300"
            runat="server">
          </cc1:Column>
        </Columns>
        <Templates>
          <cc1:GridTemplate runat="server" ID="tplEditCountry" ControlID="ddlDiversityCountry"
            ControlPropertyName="Value">
            <Template>
              <asp:DropDownList ID="ddlDiversityCountry" runat="server" DataTextField="country"
                DataValueField="countryid" AppendDataBoundItems="false">
              </asp:DropDownList>
            </Template>
          </cc1:GridTemplate>
          <cc1:GridTemplate ID="tplEditNumber" runat="server">
            <Template>
              <asp:TextBox ID="txtCountryNumber" runat="server"></asp:TextBox>
            </Template>
          </cc1:GridTemplate>
        </Templates>
      </cc1:Grid>
...
<div class="edit-school-tabs">
  ...
  <div>
      ...
      <table cellpadding="5" cellspacing="0" border="0">
        ...
        <tr>
          ...
          <td valign="top" width="150">
            <asp:RadioButtonList ID="radioReligions" runat="server" TextAlign="right" DataTextField="religion" CssClass="radioList"
    ...
    <div class="edit-school-border">
      ...
      <table cellpadding="5" cellspacing="0" border="0" width="600px">
        ...
        <tr>
          ...
          <td width="200">
            <asp:RadioButtonList ID="radioGlanceAcceptTabsApplication" runat="server" TextAlign="Right" CssClass="yesNoRadio"
              RepeatDirection="Horizontal">
              <asp:ListItem Text="Yes" Value="1" />
              <asp:ListItem Text="No" Value="2" />
            </asp:RadioButtonList>
    ...
    <div class="edit-school-border">
      ...
      <table cellpadding="5" cellspacing="0" border="0" width="600px">
        ...
        <tr>
          ...
          <td>
            <asp:RadioButtonList ID="radioGlancePaymentPlans" runat="server" TextAlign="Right" CssClass="yesNoRadio"
              RepeatDirection="Horizontal">
              <asp:ListItem Text="Yes" Value="1" />
              <asp:ListItem Text="No" Value="2" />
            </asp:RadioButtonList>
        ...
        <tr>
          ...
          <td>
            <asp:RadioButtonList ID="radioGlanceNeedBasedAid" runat="server" TextAlign="Right" CssClass="yesNoRadio"
              RepeatDirection="Horizontal">
              <asp:ListItem Text="Yes" Value="1" />
              <asp:ListItem Text="No" Value="2" />
            </asp:RadioButtonList>
    ...
    <div class="edit-school-border">
      ...
      <table cellpadding="5" cellspacing="0" border="0">
            <tr>
      <td>Show in Profile</td>
      <td colspan="3">
        <asp:RadioButtonList ID="radioGlanceShowFinance" runat="server" TextAlign="Right" CssClass="yesNoRadio"
          RepeatDirection="Horizontal">
        ...
        <tr>
          ...
          <td colspan="3">
            <asp:RadioButtonList ID="radioGlanceMerit" runat="server" TextAlign="Right" CssClass="yesNoRadio" RepeatDirection="Horizontal">
              <asp:ListItem Text="Yes" Value="1" />
              <asp:ListItem Text="No" Value="2" />
            </asp:RadioButtonList>
          </td>
    ...
    <div class="edit-school-border">
      ...
      <table cellpadding="5" cellspacing="0" border="0">
        ...
        <tr>
          ...
          <td>
            <asp:RadioButtonList ID="radioAcademicSatClasses" runat="server" TextAlign="right" CssClass="yesNoRadio"
              RepeatDirection="horizontal">
              <asp:ListItem Text="Yes" Value="1" />
              <asp:ListItem Text="No" Value="2" />
            </asp:RadioButtonList>
          ...
          <td>
            <asp:RadioButtonList ID="radioAcademicSummerPrograms" runat="server" TextAlign="right" CssClass="yesNoRadio"
              RepeatDirection="horizontal">
              <asp:ListItem Text="Yes" Value="1" />
              <asp:ListItem Text="No" Value="2" />
            </asp:RadioButtonList>
    ...
    <div class="edit-school-border">
      <table width="800px">
        ...
        <tr>
          ...
          <td valign="top">
            Other:&nbsp;<asp:TextBox ID="textAcademicSupportOther" TextMode="MultiLine" Height="100" runat="server" />
          </td>
        </tr>
        <tr>
          <td valign="top">
          ...
          <td valign="top">
            Other:&nbsp;<asp:TextBox ID="textAcademicEnrichmentOther" TextMode="MultiLine" Height="100" runat="server" />&nbsp;</td>
          <td valign="top">
      ...
      <div class="three-col">
        <div class="left">
          ...
          <ul>
            ...
            <li>Other:&nbsp;<asp:TextBox ID="textAcademicEnglishOther" TextMode="MultiLine" Height="100" runat="server" />
            </li>
          </ul>
          <p class="sm-h">
            History:</p>
          <ul>
            ...
            <li>
              <asp:CheckBox ID="checkAcademicworldHistory" Text="World History  " TextAlign="right"
                runat="server" /></li>
            <li>Other:&nbsp;<asp:TextBox ID="textAcademicHistoryOther" TextMode="MultiLine" Height="100" runat="server" />
            </li>
          </ul>
          <p class="sm-h">
            Foreign Languages:</p>
          <ul>
            ...
            <li>Other:&nbsp;<asp:TextBox ID="textAcademicForeign" TextMode="MultiLine" Height="100" runat="server" />
            </li>
          </ul>
          <p class="sm-h">
          ...
          <ul>
            ...
            <li>
              <asp:CheckBox ID="checkAcademicworldReligion" Text="World Religions  " TextAlign="right"
                runat="server" /></li>
            <li>Other:&nbsp;<asp:TextBox ID="textAcademicReligionOther" TextMode="MultiLine" Height="100" runat="server" />
            </li>
          </ul>
          <p class="sm-h">
          ...
          <ul>
            ...
            <li>
              <asp:CheckBox ID="checkAcademicworldHistoryAP" Text="World History " TextAlign="right"
                runat="server" /></li>
            <li>Other:&nbsp;<asp:TextBox ID="textAcademicAPOther" TextMode="MultiLine" Height="100" runat="server" />
            </li>
          </ul>
        </div>
        <div class="left">
          ...
          <ul>
            ...
            <li>Other:&nbsp;<asp:TextBox ID="textAcademicSocialOther" runat="server" TextMode="MultiLine" Height="100" />
            </li>
          </ul>
          <p class="sm-h">
            Sciences:</p>
            ...
            <li>
              ...
              <li>
                ...
                <li>
                  ...
                  <li>Other:&nbsp;<asp:TextBox ID="textAcademicScienceOther" runat="server" TextMode="MultiLine" Height="100" />
                  </li>
          </ul>
          <p class="sm-h">
            Math:</p>
          <ul>
            ...
            <li>Other:&nbsp;<asp:TextBox ID="textAcademicMathOther" runat="server" TextMode="MultiLine" Height="100" />
            </li>
          </ul>
          <p class="sm-h">
            Computer Studies:</p>
          <ul>
            ...
            <li>Other:&nbsp;<asp:TextBox ID="textAcademicComputerOther" runat="server" TextMode="MultiLine" Height="100" />
            </li>
          </ul>
          <p class="sm-h">
            Music:</p>
          <ul>
            ...
            <li>Other:&nbsp;<asp:TextBox ID="textAcademicMusicOther" runat="server" TextMode="MultiLine" Height="100" />
            </li>
          </ul>
        </div>
        <div class="left">
            ...
            <li>
              ...
              <li>
                <asp:CheckBox ID="checkAcademicwoodworking" Text="Woodworking " TextAlign="right"
                  runat="server" /></li>
              <li>Other:&nbsp;<asp:TextBox ID="textAcademicVisualOther" runat="server" TextMode="MultiLine" Height="100" />
              </li>
          </ul>
          <p class="sm-h">
            Special Programs:</p>
          <ul>
            ...
            <li>
              <asp:CheckBox ID="checkAcademicstudyAbroad" Text="Study Abroad" TextAlign="right"
                runat="server" /></li>
            <li>Other:&nbsp;<asp:TextBox ID="textAcademicSpecialOther" TextMode="MultiLine" Height="100" runat="server" />
            </li>
          </ul>
          <p class="sm-h">
    ...
    <div class="edit-school-border">
      ...
      <table width="820px">
        ...
        <tr>
          ...
          <td>
            Other:&nbsp;<asp:TextBox ID="textCampusFacilitiesOther" runat="server" TextMode="MultiLine" Height="100" />
          </td>
          <td>
          </td>
        </tr>
    ...
    <div class="edit-school-border">
      ...
      <table width="820px">
        ...
        <tr>
          ...
          <td>
            Other:&nbsp;<asp:TextBox ID="textCampusClubOther" runat="server" TextMode="MultiLine" Height="100" />
          </td>
          <td>
          </td>
          <td>
  ...
  <div>
    ...
    <div class="edit-school-border">
      ...
      <table cellpadding="5" cellspacing="0" border="0">
        ...
        <tr>
          ...
          <td>
            <asp:TextBox ID="athNoteworthy" runat="server"></asp:TextBox><br />
            <asp:TextBox ID="athNoteworthy2" runat="server"></asp:TextBox><br />
            <asp:TextBox ID="athNoteworthy3" runat="server"></asp:TextBox>
          </td>
        </tr>
      </table>
    </div>
    ...
    <div class="edit-school-border">
      ...
      <table width="820px">
        ...
        <tr>
          <td>
            <asp:CheckBox ID="interFootball" Text="Football " TextAlign="right" runat="server" />
          </td>
          <br />
          <td>
            <asp:CheckBox ID="interFreestyleSki" Text="Free Style Skiing " TextAlign="right"
              runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interGolf" Text="Golf " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interGymnastics" Text="Gymnastics " TextAlign="right" runat="server" />
          </td>
        </tr>
        <tr>
          <td>
            <asp:CheckBox ID="interHandball" Text="Handball " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interHiking" Text="Hiking " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interHorseback" Text="Horseback Riding " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interIceClimbing" Text="Ice Climbing " TextAlign="right" runat="server" />
          </td>
        </tr>
        <tr>
          <td>
            <asp:CheckBox ID="interIceHockey" Text="Ice Hockey " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interIceSkating" Text="Ice Skating " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interKayaking" Text="Kayaking " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interKickball" Text="Kickball " TextAlign="right" runat="server" />
          </td>
        </tr>
        <tr>
          <td>
            <asp:CheckBox ID="interKickboxing" Text="Kickboxing " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interLacrosse" Text="Lacrosse " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interLuge" Text="Luge " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interMartialArt" Text="Martial Arts " TextAlign="right" runat="server" />
          </td>
        </tr>
        <tr>
          <td>
            <asp:CheckBox ID="interMtBike" Text="Mountain Biking " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interNordicSkiRacing" Text="Nordic Ski Racing " TextAlign="right"
              runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interNordicSki" Text="Nordic Skiing " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interOutdoorEdu" Text="Outdoor Education " TextAlign="right" runat="server" />
          </td>
        </tr>
        <tr>
          <td>
            <asp:CheckBox ID="interPaddleTennis" Text="Paddle Tennis " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interPolo" Text="Polo " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interPowerLifting" Text="Power Lifting " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interRacquet" Text="Racquet Ball " TextAlign="right" runat="server" />
          </td>
        </tr>
        <tr>
          <td>
            <asp:CheckBox ID="interRafting" Text="Rafting " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interRifle" Text="Rifle Team " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interRockClimbing" Text="Rock Climbing " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interRugby" Text="Rugby " TextAlign="right" runat="server" />
          </td>
        </tr>
        <tr>
          <td>
            <asp:CheckBox ID="interSailing" Text="Sailing " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interSkateboard" Text="Skateboarding " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interSkiJump" Text="Ski Jumping " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interSnowboard" Text="Snowboarding " TextAlign="right" runat="server" />
          </td>
        </tr>
        <tr>
          <td>
            <asp:CheckBox ID="interSoccer" Text="Soccer " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interSoftball" Text="Softball " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interSquash" Text="Squash " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interSurfing" Text="Surfing " TextAlign="right" runat="server" />
          </td>
        </tr>
        <tr>
          <td>
            <asp:CheckBox ID="interSwimming" Text="Swimming " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interTableTennis" Text="Table Tennis " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interTennis" Text="Tennis " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interTrackField" Text="Track and Field " TextAlign="right" runat="server" />
          </td>
        </tr>
        <tr>
          <td>
            <asp:CheckBox ID="interUltFrisbee" Text="Ultimate Frisbee " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interVolleyball" Text="Volleyball " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interWaterPolo" Text="Water Polo " TextAlign="right" runat="server" />
          </td>
          <td>
            <asp:CheckBox ID="interWeightLifting" Text="Weight Lifting " TextAlign="right" runat="server" />
          </td>
        </tr>
        <tr>
          <td valign="top">
            <asp:CheckBox ID="interWrestling" Text="Wrestling " TextAlign="right" runat="server" />
          </td>
          <td>
            Other:&nbsp;<asp:TextBox ID="textSportsOther" runat="server" TextMode="MultiLine" Height="100" />
          </td>
          <td>
          </td>
          <td>
    ...
    <div class="edit-school-border">
      ...
      <table cellpadding="5">
        <tr>
          ...
          <td class="edit-small" width="100">
            <asp:TextBox ID="textCollegePercHigherEd" runat="server" Text="0" />%
          </td>
          <td class="align-r">
    ...
    <div class="edit-school-border">
      ...
      <table class="align-r">
        ...
        <tr>
          ...
          <td>
            <asp:TextBox ID="TextBox2" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <asp:TextBox ID="TextBox4" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <asp:TextBox ID="TextBox6" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <asp:TextBox ID="TextBox8" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <asp:TextBox ID="TextBox10" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <asp:TextBox ID="TextBox12" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <asp:TextBox ID="TextBox14" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <asp:TextBox ID="TextBox16" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <asp:TextBox ID="TextBox18" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <asp:TextBox ID="TextBox20" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <asp:TextBox ID="TextBox22" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
            <asp:TextBox ID="TextBox28" runat="server" Width="25px" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <asp:TextBox ID="TextBox30" runat="server" Width="25px" />
          </td>
        </tr>
      </table>
    </div>
    ...
    <div class="edit-school-non">
      <table>
        <tr>
          ...
          <td>
            <asp:RadioButtonList RepeatDirection="Horizontal" ID="rdoCustom" CssClass="yesNoRadio" runat="server">
    ...
    <div class="overlaybox">
      <div class="paybox" id="paybox">
        ...
        <div class="paybox-bm">
            ...
            <asp:View ID="choiceView" runat="server">
              ...
              <table>
                <tr>
                  <td>
                    <a href="#pay-credit">
                      <input type="radio" value="credit-card" name="pay" /></a>Credit Card
                  </td>
                  <td>
                    <a href="#pay-later">
          ...
          <div id="pay-credit" class="pop-suddn">
            <div class="pop-up">
              <asp:MultiView ID="ccPayView" runat="server">
                <asp:View ID="billingView" runat="server">
                  <b>Full Name:</b>&nbsp;<asp:TextBox ID="txtFName" runat="server"></asp:TextBox><asp:RequiredFieldValidator
                    ID="rfvFName" runat="server" Display="Dynamic" ErrorMessage="&nbsp;Required"></asp:RequiredFieldValidator><br />
                  <b>Email:</b>&nbsp;<asp:TextBox ID="txtEmail" runat="server"></asp:TextBox><br />
                  <b>Address 1:</b>&nbsp;<asp:TextBox ID="txtAdd1" runat="server"></asp:TextBox><asp:RequiredFieldValidator
                    ID="rfvAdd1" runat="server" Display="Dynamic" ErrorMessage="&nbsp;Required"></asp:RequiredFieldValidator><br />
                  <b>Address 2:</b>&nbsp;<asp:TextBox ID="txtAdd2" runat="server"></asp:TextBox><br />
                  <b>City:</b>&nbsp;<asp:TextBox ID="txtCity" runat="server"></asp:TextBox><asp:RequiredFieldValidator
                    ID="rfvCity" runat="server" Display="Dynamic" ErrorMessage="&nbsp;Required"></asp:RequiredFieldValidator><br />
                  <b>Country:</b>&nbsp;<asp:DropDownList ID="ddlCountry" runat="server" DataTextField="country"
                    DataValueField="countryid" AutoPostBack="true">
                  </asp:DropDownList>
                  <br />
                  <b>State:</b>&nbsp;<asp:DropDownList ID="ddlState" runat="server" DataTextField="state"
                    DataValueField="stateid">
                  </asp:DropDownList>
                  <br />
                  <b>Zip:</b>&nbsp;<asp:TextBox ID="txtZip" runat="server"></asp:TextBox><br />
                  <b>Phone:</b>&nbsp;<asp:TextBox ID="txtPhone" runat="server"></asp:TextBox><br />
                  <asp:Button ID="btnNextCC" Text="Next" runat="server" OnClick="btnNextCC_Click" />
                </asp:View>
