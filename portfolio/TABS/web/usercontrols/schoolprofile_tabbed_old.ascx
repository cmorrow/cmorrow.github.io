              ...
              <div class="school-pro-val">
                ...
                <p>
                  Number of AP Courses Offered: <span>
                    <%#Eval("apcourses") %></span></p>
                <p>
                  Notable Achievements: <span>
                    <%#Eval("noteworthy") %></span></p>
              </div>
            </div>
          </ItemTemplate>
        </asp:Repeater>
            ...
            <div class="left fs-section">
              <div class="school-out-val nobull mar0">
                <h5>
                  Dorm Life</h5>
                <p>
                  Number of Dorms: <span>value goes here</span></p>
                <p>
              ...
              <div class="school-pro-val">
                <p>
                  Arts Department Director: <span>
                    <%#Eval("artdirectorfirstname") %>
                    <%#Eval("artdirectorlastname") %></span></p>
                <p>
                  Athletics Department Director: <span>
                    <%#Eval("athleticdirectorfirstname") %>
                    <%#Eval("athleticdirectorlastname") %></span></p>
                <p>
                  Notable Achievements: <span>
                    <%#Eval("achievements") %></span></p>
              </div>
            </div>
          </ItemTemplate>
        </asp:Repeater>
          ...
          <ItemTemplate>
            ...
            <div class="left fs-section">
              <div class="school-out-val nobull mar0">
                ...
                <p>
                  Percentage of Graduates Who Attend College: <span>value goes here</span></p>
                <p>
