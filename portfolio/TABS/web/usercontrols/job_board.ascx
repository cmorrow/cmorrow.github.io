...
<div style="padding:0 0 10px 0">
    <img src="../resources/images/jobBoard.gif" />
</div>
    ...
    <obout:Grid ID="gridResults" runat="server" AutoGenerateColumns="false" AllowAddingRecords="false">
        ...
        <templates>
            <obout:GridTemplate runat="server" ID="tmpTitle">
                <Template>
                    <a href='/for-schools/job-board/job-listing.aspx?jobId=<%# Container.DataItem["JobId"] %>'><%# Container.DataItem["JobTitle"] %></a><br />
            ...
            <div class="job-menu">
                <div class="col1 left">
                    <h2>
                        Search Jobs</h2>
                    <div class="leftCol left">
                        <h4>There are currently no open positions with TABS.</h4>
                    </div>
                    <%--<div class="rightCol left">
