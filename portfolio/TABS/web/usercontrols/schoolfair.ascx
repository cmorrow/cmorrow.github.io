<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="schoolfair.ascx.cs"
  Inherits="TABS_UserControls.usercontrols.schoolfair" %>
<%@ Register Assembly="obout_Grid_NET" Namespace="Obout.Grid" TagPrefix="cc1" %>
<cc1:Grid ID="fairGrid" runat="server" CallbackMode="true" Serialize="true" GenerateRecordIds="true"
  ...
  <Template>
        <asp:HyperLink Text='<%# Container.DataItem["profileevent"] %>' NavigateUrl='<%# "../for-schools/school-events-detail.aspx?schoolid=000000&type=1&eventid=" + Container.DataItem["profileeventid"]%>'
