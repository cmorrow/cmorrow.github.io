...
namespace TABS_UserControls.usercontrols {
    public partial class schooleventsrss : System.Web.UI.UserControl {
        protected void Page_Load(object sender, EventArgs e) {
            ...
            feedWriter.WriteElementString("title", "TABS School Events");
            ...
            DataTable dt = rss.getSchoolEventsRSS();
            if (dt.Rows.Count > 0) {
                ...
                feedWriter.WriteStartElement("item");
                feedWriter.WriteElementString("title", "No Latest Events for Schools");
