<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="conference.ascx.cs" Inherits="TABS_UserControls.usercontrols.conference" %>
    ...
    <asp:Image runat="server" ID="imgConferenceLogo" CssClass="conf-img left" />
            ...
            <div class="tc floatclear" runat="server" id="divMainContainer">
               <ul class="cf-menu left" runat="server" id="ulTabs">
                ...
                <div id="conference2" class="tr left">
                    ...
                    <a href="/for-schools/professional-development/conferences/proposal-conference.aspx">Submit a Proposal</a><br />
                    <a href="/for-schools/professional-development/conferences/proposal-management.aspx">Manage Your Proposals</a>
                    <div class="conf-small-tabs1 floatclear" >
                        <ul class="tabs-in-conf-ul small-in-tabs">
                            <li><a href="#call-cor-pro1">Proposal Categories</a></li>
                            <li><a href="#call-cor-pro2">Suggested Topics</a></li>
                            <li><a href="#call-cor-pro3">Submission and Review</a></li>
                            <li><a href="#call-cor-pro4">Financial Arrangements</a></li>
                        </ul>
                ...
                <div id="conference3" class="tr left">
                    ...
                    <div class="conf-small-tabs2 floatclear">
                        <ul class="tabs-in-conf-ul small-in-tabs">
                            <li><a href="#spon-oppt1">Sponsorship Levels</a></li>
                            <li><a href="#spon-oppt2">Exhibit Hall</a></li>
                        </ul>
                        <div id="spon-oppt1">
                ...
                <div id="conference7" class="tr left">
                    ...
                    <div class="conf-small-tabs3 small-in-tabs floatclear">
                        <ul class="tabs-in-conf-ul ">
                            <asp:Repeater runat="server" ID="rptConcurrentSessionBlocks">
                                <ItemTemplate>
                                    <li><a href='#conccr-sess<%# Eval("ConferenceConcurrentSessionBlockId") %>'><%# Eval("BlockName") %>: <%# String.Format("{0:m}", (DateTime)Eval("BlockDate")) %><br /><%# String.Format("{0:t}", (DateTime)Eval("StartTime")) %></a></li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
