...
<div class="bm left no-padding">
	...
	<div id="asiaWrapper">
		...
		<div class="asia-reg right">
		    ...
		    <!-- end top div -->
		      ...
		      <div class="content gray">
				...
				<p class="bold"><asp:Label ID="lbHotelLocation" runat="server" Text=""></asp:Label> | 
		...
		<div class="event-info right">
		    ...
		    <div class="pre-fair">
       			<p><asp:Label ID="lbSpecialInfoHdr" runat="server" Text="Special Information" Visible=false></asp:Label></p>
   				<p><asp:Label ID="lbSpecialInfo" runat="server" Text="Special Information" Visible=false></asp:Label></p>
   			</div>
		    <p><a href="https://www.regonline.com/AsiaFairs">Register for this fair</a></p>
		</div>
		<!-- end event-info -->
		<div class="clear"></div>
      </div>
