...
namespace TABS_UserControls.usercontrols {
    public partial class schoolnewsrss : System.Web.UI.UserControl {
        protected void Page_Load(object sender, EventArgs e) {
            ...
            feedWriter.WriteElementString("title", "TABS School News");
            ...
            DataTable dt = rss.getSchoolNewsRSS();
            if (dt.Rows.Count > 0) {
                foreach (DataRow row in dt.Rows) {
                    ...
                    string baseurl = "/about-tabs/about-us/press-room/articles.aspx?section=school&id=";
                    feedWriter.WriteElementString("link", baseurl + row["schoolnewsid"].ToString());
